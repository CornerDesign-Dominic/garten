    ...
    <PageShell>
      <section className="max-w-3xl space-y-7 py-8 md:py-12">
        ...
        <h1 className="text-4xl font-semibold leading-tight text-zinc-900 md:text-5xl">
          Ein klarer Ort für Planung, Pflege und Übersicht im Gartenjahr.
        </h1>
        <p className="text-base leading-8 text-zinc-600 md:text-lg">
          Diese erste Version schafft die Grundlage für ein wachsendes Produkt:
          ruhig gestaltet, technisch sauber aufgebaut und bereit für nächste
          Funktionen.
        </p>
      </section>
      ...
      <section className="grid gap-5 py-10 md:grid-cols-3 md:py-12">
        <article className="rounded-2xl border border-emerald-900/10 bg-white/60 p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-600">
            Bereich für Beete, Pflanzungen und individuelle Notizen pro Saison.
          </p>
        </article>
        <article className="rounded-2xl border border-emerald-900/10 bg-white/60 p-6">
          <h2 className="text-lg font-semibold text-zinc-900">Der Kalender</h2>
          <p className="mt-3 text-sm leading-7 text-zinc-600">
            Zeitliche Struktur für Aufgaben, Pflegefenster und wiederkehrende
            Routinen.
          </p>
        </article>
        <article className="rounded-2xl border border-emerald-900/10 bg-white/60 p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-600">
            Platz für künftige Module wie Erinnerungen, Auswertungen und
      ...
      <section className="max-w-3xl space-y-5 border-t border-emerald-900/10 py-10 md:py-12">
        ...
        <p className="text-base leading-8 text-zinc-600">
          Die Oberfläche nutzt ein wiederverwendbares Seitenlayout mit fester
          Struktur. Dadurch lassen sich neue Seiten und Funktionsbereiche
          konsistent erweitern, ohne das visuelle Grundgerüst neu aufzubauen.
        </p>
      </section>
    </PageShell>
  );
